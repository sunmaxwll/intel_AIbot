...
class CamShiftNode(ROS2OpenCV3):
    def __init__(self, node_name):
        ROS2OpenCV3.__init__(self, node_name)
    ...
    def process_image(self, cv_image):
        ...
        if self.hist is not None:
            ...
            cv2.moveWindow("Backproject", 700, 400)
    ...
    def hue_histogram_as_image(self, hist):
            ...
            histimg = cv2.cvtColor(histimg_hsv, cv2.HSV2BGR)
